...
export const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  1: {
    ...
    wordType: 'Simple CVC only: cat, dog, sun, hat, big',
    wordCount: 1,
  ...
  2: {
    ...
    wordType: 'CVC patterns: frog, jump, skip, drip, clap',
    wordCount: 2,
  ...
  3: {
    ...
    wordType: 'Consonant blends: flag, slip, grin, clap, stop',
    wordCount: 3,
  ...
  4: {
    ...
    wordType: 'Sight words + 2-syllable: little, funny, happy',
    wordCount: 4,
  ...
  5: {
    ...
    wordType: 'Multi-syllable: adventure, sparkle, discover',
    wordCount: 5,
